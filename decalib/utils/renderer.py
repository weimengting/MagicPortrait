...
class SRenderY(nn.Module):
    ...
    def forward(self, vertices, transformed_vertices, albedos, lights=None, h=None, w=None,
                light_type='point', background=None, add_light=True, th=0, render_norm=False):
        depth_images = self.render_depth(transformed_vertices, h, w)
    ...
    def render_depth(self, transformed_vertices, h, w):
        '''
        -- rendering depth
        '''
