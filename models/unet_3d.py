...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def from_pretrained_2d(
        ...
        # /media/mengting/Expansion/diffusion_models/champ/stable-diffusion-v1-5/unet/config.json
        unet_config = cls.load_config(config_file)
        # 对里面的一些config进行更改
        unet_config["_class_name"] = cls.__name__ # UNet3DConditionModel
        ...
        model = cls.from_config(unet_config, **unet_additional_kwargs) # 初始化模型
        ...
        # /media/mengting/Expansion/diffusion_models/champ/champ/motion_module.pth
        ...
        m, u = model.load_state_dict(state_dict, strict=False) # 返回是否有丢失和多余的参数
