...
class MultiGuidance2LongVideoPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.register_modules(
            ...
            guidance_encoder_render=guidance_encoder_render,
            scheduler=scheduler,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        encoder_hidden_states = text_prompts
        if do_classifier_free_guidance:
            encoder_hidden_states = torch.cat(
                [text_prompts, text_prompts], dim=0
            )
        ...
        for guidance_type, guidance_pil_lst in multi_guidance_group.items():
            ...
            guidance_tensor = guidance_tensor.unsqueeze(0)  # (1, c, f, h, w) [1, 3, 100, 512, 512]
            ...
            if self.guidance_process_size: # None
                ...
                guidance_fea_lst += [guidance_encoder(guidance_tensor)] # length = 4
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i == 0:
                    ...
                    reference_control_reader.update(reference_control_writer) # reader is denoising unet
